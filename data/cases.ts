...
export const cases: Case[] = [
  ...
  },
  {
    ...
    technologies: ['Next.js', 'TypeScript', 'TailwindCSS', 'NestJS'],
  ...
  },
  {
    ...
    technologies: ['微信小程序', 'Taro', 'SpringBoot', 'MySQL'],
  ...
  },
  {
    id: '4',
    title: '桌面办公软件',
    description: '跨平台桌面应用，支持 Windows 和 macOS',
    category: 'web',
    image: 'https://images.unsplash.com/photo-1551434678-e076c223a692?w=800&h=600&fit=crop',
    technologies: ['Electron', 'React', 'TypeScript', 'SQLite', 'Node.js'],
    clientFeedback: '系统稳定可靠，功能强大，离线使用非常方便。',
    features: [
      '原生性能体验',
      '离线数据存储',
      '跨平台兼容',
  ...
  },
  {
    ...
    technologies: ['React Native', 'Express', 'Redis', 'PostgreSQL', 'WebSocket'],
  ...
  },
  {
    ...
    technologies: ['PHP', 'Laravel', 'Vue', 'MySQL', 'Redis'],
